        ...
        <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-3">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 text-base font-semibold text-foreground">
              <span className="font-normal text-muted-foreground">{t('res.section.overview')}</span>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Badge
                ...
                className="h-5 px-1.5 py-0 text-[10px] font-medium leading-5"
              >
                {t('res.summary.progress', { progress: derivedOrderProgress })}
              </Badge>
            </div>
          </div>
            ...
            {focusedLabel ? (
              <>
                ...
                <div
                  ...
                  title={focusedLabel}
                >
                  {t('res.summary.current_case', { case: focusedLabel })}
                </div>
              </>
            ) : null}
          </div>
